...
const getCurrentLanguage = (): 'pt-BR' | 'en-US' => {
    const savedRegion = localStorage.getItem('region');
    return savedRegion === 'US' ? 'en-US' : 'pt-BR';
};
                    ...
                    <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 p-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-100 font-medium rounded-lg transition-colors"
                            >
...
// Route Error Element for React Router errors
